export const demoSources = [
  ...
  },
  {
    ...
    content: "这是虚构的脱敏经历，仅用于展示来源分级。作者称当天先签到再参加考核。作者回忆机试侧重图搜索与动态规划，面试追问了项目中指标的选择依据。作者早期笔记写成“机试共 3 题”，作者修订时又注明“题量记忆不清”。个人回忆可能存在偏差，不应视作学校规则。",
  },
  {
...
export const demoEvidences = [
  ...
  { suffix: "E04", sourceSuffix: "source-experience", quote: "作者早期笔记写成“机试共 3 题”", locator: "修订记录 · 第 1 版", located: true },
  { suffix: "E05", sourceSuffix: "source-experience", quote: "作者修订时又注明“题量记忆不清”", locator: "修订记录 · 第 2 版", located: true },
] as const
...
export const demoClaims = [
  ...
  { suffix: "C04", content: "同一作者早期版本回忆机试为 3 题", claimType: "他人经验陈述", evidenceSuffixes: ["E04"], scope: "2025 考核 · 夏令营", verification: "conflicted", conflictSuffixes: ["C05"] },
  { suffix: "C05", content: "同一作者修订后称题量记忆不清", claimType: "他人经验陈述", evidenceSuffixes: ["E05"], scope: "2025 考核 · 夏令营", verification: "conflicted", conflictSuffixes: ["C04"] },
] as const
